...
public class CodebaseUtil {
    ...
    private static final String TOKEN_SECRET = "codebase-secret-sauce-from-the-outer-space";
    ...
    public static String hash(String value) {
        try {
            ...
            Logger.getLogger(CodebaseUtil.class.getName()).log(Level.SEVERE, null, ex);
