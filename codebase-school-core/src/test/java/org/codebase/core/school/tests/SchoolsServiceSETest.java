...
public class SchoolsServiceSETest {
    ...
    public static JavaArchive createDeployment() {
        ...
        return ShrinkWrap.create(JavaArchive.class)
                ...
                .addAsManifestResource("META-INF/schools.xml", "schools.xml")
                .addAsManifestResource("META-INF/teachers.xml", "teachers.xml")
                .addAsManifestResource("META-INF/years.xml", "years.xml")
                .addAsManifestResource("META-INF/schoolclasses.xml", "schoolclasses.xml")
                .addAsManifestResource("META-INF/students.xml", "students.xml")
